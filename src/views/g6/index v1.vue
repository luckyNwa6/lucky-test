    ...
    return {
      ...
      cards: [
        ...
        },
        {
          title: '服务推送情况',
          rows: [
            { label: '新核心开发平台服务推送数', value: '12（09:45）' },
            { label: '新信创开发平台服务推送数', value: '8（09:12）' },
          ],
        },
        {
          title: '一体化测试平台',
          rows: [
            { label: '一体化测试平台同步服务次数', value: 34 },
        ...
        },
        {
          title: '网关调用',
          rows: [
            { label: '网关调用链路数', value: 96 },
            { label: 'uat阶段链路数', value: 12 },
            { label: '准生产阶段链路数', value: 84 },
            { label: '上线链路数', value: 84 },
          ],
        },
      ],
    }
